...
Tous comme les questions des tests et celles des quiz, il y aura moyen de pousser plus loin dans les réflexions pour créer des exercices à faire directement en classe afin de développer des modèles mentaux solides au lieu de parcourir beaucoup de sujets. Exemple: Voir/critiquer/réfléchir différentes implémentations/sécurisations face à certaines attaques web.

## Idée 1 - Practice runner
