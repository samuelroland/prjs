...
Other useful documents: [exos.md](exos.md) - [todos.md](todos.md) - [dev.md](dev.md)
...
If you are a student, things should already be setup in the exos repository and you should just be able to type `npx prjs` to run it !
...
- `2024-08-17`: [@samuelroland](https://codeberg.org/samuelroland) released the first version on npmjs.com. Before this, he continued to fix a few bugs, implement a partial list system, add a build system, try to write some automated tests, and write a CHANGELOG.md.
