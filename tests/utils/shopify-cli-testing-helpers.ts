// This file specifically contains functions copy pasted from https://github.com/Shopify/cli/blob/main/packages/cli-kit/src/private/node/testing/ui.ts
// They have not been modified for now...
